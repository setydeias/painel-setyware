<?php
    ...
    class StrategyRemessaSICOOB implements IStrategyRemessaRegistrada {

        public function GenerateFileHeader($params) {
            $header = $params['cod_banco'].'00000'.str_pad('', 9, ' ', STR_PAD_RIGHT).$params['tipo_documento'].$params['documento'].str_pad('', 20, ' ', STR_PAD_RIGHT);
        ...
        public function GenerateLoteHeader($params) {
			...
			$header .= str_pad($params['conta'], 13, '0', STR_PAD_LEFT).' '.str_pad(substr($params['razao_social'], 0 , 30), 30, ' ', STR_PAD_RIGHT).str_pad('', 80, ' ', STR_PAD_RIGHT).'00000001';
